...
export default function About() {
  return (
      ...
      Although I appreciate the importance of Javascript and frontend technology, I am heavily interested in exploring the potential of Python and its backend frameworks to build scalable applications and software. </Typography>
      <Typography variant='p' className='abouttxt' sx={{fontFamily: 'Inconsolata-Variable'}}>
      I find nature fascinating and also enjoy a wide range of alternative music. In my spare time, I like to scribble my thoughts into words - it also makes for good poetry.  </Typography>
      <Typography variant='p' className='abouttxt' sx={{fontFamily: 'Inconsolata-Variable'}}>
